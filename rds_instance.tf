...
resource "aws_cloudwatch_metric_alarm" "cpu_utilization_too_high" {
  ...
  alarm_name          = "${var.env}-${var.db_instance_id}-highCPUUtilization"
...
resource "aws_cloudwatch_metric_alarm" "disk_free_storage_space_too_low" {
  ...
  alarm_name          = "${var.env}-${var.db_instance_id}-lowFreeStorageSpace"
...
resource "aws_cloudwatch_metric_alarm" "memory_freeable_too_low" {
  ...
  alarm_name          = "${var.env}-${var.db_instance_id}-lowFreeableMemory"
  comparison_operator = "LessThanThreshold"
  evaluation_periods  = var.evaluation_period
...
resource "aws_cloudwatch_metric_alarm" "connection_count_anomalous" {
  ...
  alarm_name          = "${var.env}-${var.db_instance_id}-anomalousConnectionCount"
